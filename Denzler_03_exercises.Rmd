...
```
  ...
  -  area under both combined is 1, showing distribution of hour for casual and registered combined, reflecting proportion of registered and casual
...
left_join(Trips3, Stations, by = "name") #%>% 
  #ggplot(aes(x = lat, y = long)) +
   # geom_jitter(color = name)
```
